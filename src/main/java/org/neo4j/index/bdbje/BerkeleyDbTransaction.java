        ...
        try
        {
                ...
                this.commandMap.entrySet() )
            {
                ...
                for ( BerkeleyDbCommand command : commandList )
                {
                    ...
                    {
                        dataSource.indexStore.setIfNecessary( command.indexId.itemClass, command.indexId.indexName,
